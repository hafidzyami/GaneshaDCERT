...
router.post(
  ...
  [
    ...
    body('password', 'Password minimal 6 karakter')
      .trim()
      .isLength({ min: 6 }),
    body('name', 'Nama tidak boleh kosong')
      .trim()
      .notEmpty(),
  ],
  createAdmin
...
router.post(
  ...
  adminAuthMiddleware,
  [
    body('currentPassword', 'Password lama tidak boleh kosong')
      .trim()
      .notEmpty(),
    body('newPassword', 'Password baru minimal 6 karakter')
      .trim()
      .isLength({ min: 6 }),
  ],
  changePassword
